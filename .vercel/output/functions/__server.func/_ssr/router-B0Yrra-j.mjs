...
//#region node_modules/.nitro/vite/services/ssr/assets/router-B0Yrra-j.js
var router_B0Yrra_j_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-BeJOpwOL.css";
var APP_NAME = "Lumina";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Lumina — استودیوی سه‌بعدی حرفه‌ای برای مدل‌سازی، متریال، نورپردازی، انیمیشن، رندر و پایتون"
			},
			{
				name: "theme-color",
				content: "#141416"
...
var $$splitComponentImporter = () => import("./routes-OE8atDG2.mjs").then((n) => n.t);
...
//#endregion
export { getRouter, router_B0Yrra_j_exports as t };
